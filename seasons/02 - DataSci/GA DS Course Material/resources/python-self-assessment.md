...
* [Introduction to Python](http://introtopython.org/): A series of Jupyter notebooks that do a great job explaining core Python concepts and data structures.
...
* [Python Tutor](http://pythontutor.com/): Allows you to visualise the execution of Python code.
...
### SPOILER ALERT
DO NOT REVIEW UNTIL YOU HAVE COMPLETED THE SELF-ASSESSMENT
